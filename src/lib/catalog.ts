...
export const APP_CATALOG: Record<string, Category> = {
  ...
  'Productivity': {
    description: 'Get work done with powerful productivity tools',
    apps: [
      {
        id: 'aurua-office',
        name: 'Aurua Office',
  ...
  'Gaming': {
    description: 'Create and play games across all platforms',
    apps: [
      {
        id: 'aurua-engine',
  ...
  'Media & Creative': {
    description: 'Create stunning content and stream to the world',
    apps: [
      {
        id: 'aurua-streaming',
